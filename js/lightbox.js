...
Lightbox.prototype = {
	...
	initialize: function() {	
		...
		if(animate){
			Element.setWidth('outerImageContainer', 250);  //archivo lightbox.css
	...
	resizeImageContainer: function( imgWidth, imgHeight) {
		...
		this.xScale = ( widthNew / this.widthCurrent)* 100;  // cuadro de fondo imagen
...
function initLightbox() { myLightbox = new Lightbox();
var firstLight;
if((firstLight=document.getElementById('first')) && /^lightbox/.test(firstLight.rel))
firstLight.onclick.apply(firstLight);
